...
def select_question_type():
    question_type = st.selectbox("Select Question Type", ["Multiple Choice", "True/False", "Short Answer Type"])
...
def get_information():
    ...
    if generate_button:
        ...
        with st.spinner('Converting Video File to Text..'):
            get_audio_file(url)
...
def download_quiz():
    ...
    pdf.cell(200, 10, txt="EduPrepAI", ln=1, align='C')
...
def main():
    ...
    st.set_page_config(page_title="EduPrep AI", page_icon="🤖")

    st.header("EduPrep AI 🤖")
    st.markdown("Quiz Gen turns your educational video lectures into engaging MCQ based quizzes and provides automatic assessment. Learning has never been this fun!")
    st.write("")
